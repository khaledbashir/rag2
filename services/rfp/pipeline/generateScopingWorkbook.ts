...
function buildRespMatrix(
  ...
  // Boilerplate Responsibility Matrix — cleaned-up baseline that estimators refine per-deal in the exported workbook.
  // Sections list ANC-owned items first, then Purchaser-owned items. Notes-only statements live in the proposal text, not here.
  const sections: { title: string; items: [string, string, string][] }[] = [
    {
      title: "Administrative",
      items: [
        ["Ship all equipment to project site", "X", ""],
        ["Receive, unload, and inspect equipment on arrival", "X", ""],
        ["Provide accurate architectural, structural, and AV drawings", "", "X"],
        ["Provide Payment and Performance Bond", project.bondRequired ? "X" : "NA", ""],
        ["Obtain all required permits (zoning, building, street, sidewalk)", "", "X"],
        ["Provide secured on-site storage for equipment and control room", "", "X"],
        ["Provide unobstructed access to install location and control room", "", "X"],
        ["Coordinate ANC's work with other on-site trades", "", "X"],
      ],
    },
    {
      title: "Engineering & Submittals",
      items: [
        ["Provide mechanical, electrical, and structural drawings with load calculations for new equipment", "X", ""],
        ["Engineer and certify new equipment attachments", "X", ""],
        ["Provide one (1) round of submittal revisions", "X", ""],
        ["Confirm existing structure supports new equipment load", "", "X"],
        ["Confirm structural integrity of existing site conditions", "", "X"],
        ["Approve ANC-provided mechanical and electrical drawings", "", "X"],
      ],
    },
    {
      title: "Physical Installation",
      items: [
        ["Fabricate, deliver, and install equipment support structure", "X", ""],
        ["Provide and install LED components", "X", ""],
        ["Remove and dispose of existing equipment (where applicable)", "X", ""],
        ["Provide site safety oversight during ANC scope (OSHA compliance)", "X", ""],
        ["Provide all required floor and site protection during installation", "", "X"],
        ["Provide base-building structural modifications (where required)", "", "X"],
      ],
    },
    {
      title: "Electrical & Data Installation",
      items: [
        ["Submit electrical engineering drawings detailing power requirements", "X", ""],
        ["Furnish signal cables as specified by ANC", "X", ""],
        ["Pull signal cable through conduit", "X", ""],
        ...
        ["Provide secondary electrical panels and remote disconnects", "", "X"],
        ["Provide and install signal cable conduit", "", "X"],
        ["Provide high-speed internet connection to control room", "", "X"],
        ["Provide static IP address at least five (5) days prior to installation", "", "X"],
      ],
    },
    {
      title: "Control System",
      items: [
        ["Provide and configure display processors", "X", ""],
        ["Commission control system and verify signal path", "X", ""],
        ["Provide climate-controlled control room (temperature, humidity, fire suppression)", "", "X"],
      ],
    },
    {
      ...
      items: [
        ...
        ["Perform one (1) day of operations and maintenance training", "X", ""],
        ["Provide signed training acceptance documentation", "X", ""],
        ["Issue final acceptance and project sign-off", "", "X"],
      ],
    },
    {
      title: "General Conditions",
      items: [
        ["Parts-only warranty (extended labor warranty available as separate scope)", "X", ""],
        [project.isUnionLabor ? "Installation labor at union rates" : "Installation labor at prevailing wage rates", "X", ""],
        ["Shipping and freight insurance during transit", "X", ""],
        ["Bonding (where required by contract)", project.bondRequired ? "X" : "NA", ""],
        ["Sales tax (not included in ANC pricing)", "", "X"],
      ],
    },
  ];
