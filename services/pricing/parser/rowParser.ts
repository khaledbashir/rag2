/**
 * Row Parsing — converts raw Excel rows into typed RawRow[] with metadata.
 * Includes subtotal detection and number parsing utilities.
 */

import type { RawRow, ColumnMap } from "./types";
import { findHeaderRowIndex } from "./columnDetection";
