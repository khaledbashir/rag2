    ...
    const workbookScreens = useMemo<ExtractedLEDSpec[]>(() => {
        return answers.displays.map((display, index) => {
            ...
            return {
                ...
                widthPx: display.fixedWidthPx || (pitch && display.widthFt ? Math.round(display.widthFt * 304.8 / pitch) : null),
                heightPx: display.fixedHeightPx || (pitch && display.heightFt ? Math.round(display.heightFt * 304.8 / pitch) : null),
                pixelPitchMm: pitch,
