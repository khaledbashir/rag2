            ...
            {[
                ...
                <div key={idx} className="space-y-2 break-inside-avoid">
                    <div className="break-inside-avoid">
                        <div className="font-bold text-[14px]" style={{ color: colors.text }}>{party.title}</div>
                        {party.address && (
                            <div className="text-[13px] leading-snug whitespace-pre-wrap" style={{ color: colors.textMuted }}>
                                {party.address}
                            </div>
                        )}
                    </div>
                    <div className="break-inside-avoid">
                        <div className="text-[13px] uppercase tracking-wide mb-0.5" style={{ color: colors.textMuted }}>By:</div>
                        <div className="h-6 border-b-2" style={{ borderColor: colors.border }} />
                    </div>
                    <div className="break-inside-avoid">
                        <div className="text-[13px] uppercase tracking-wide mb-0.5" style={{ color: colors.textMuted }}>Title:</div>
                        <div className="h-5 border-b" style={{ borderColor: colors.border }} />
                    </div>
                    <div className="break-inside-avoid">
                        <div className="text-[13px] uppercase tracking-wide mb-0.5" style={{ color: colors.textMuted }}>Date:</div>
                        <div className="h-5 border-b" style={{ borderColor: colors.border }} />
                    </div>
                </div>
            ))}
