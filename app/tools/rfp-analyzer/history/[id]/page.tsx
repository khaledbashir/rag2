...
export default function AnalysisDetailPage() {
  ...
  const handleScoping = async () => {
    ...
    try {
      await downloadBlob("/api/rfp/pipeline/scoping-workbook", { analysisId: analysis.id, clientPricedDisplays: pricingPreview?.displays || undefined }, "Scoping_Workbook.xlsx");
    } catch (err: any) {
