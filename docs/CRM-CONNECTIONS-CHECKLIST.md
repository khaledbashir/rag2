...
| A2 | **`universalCrmPush` actually lands Notes** (PDF/Excel/SOW/audit) — currently silent-fail (3 Notes ever, 0 of 855 proposals carry `twentyOpportunityId`) | 🔴 | rag2 DB query 2026-04-26 — see `docs/claude-memory/MEMORY.md` discovery log |
