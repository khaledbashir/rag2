<!--
SOURCE OF TRUTH for the ANC Service Contract Agreement template (Natalia ask 2026-07-06).
Extracted VERBATIM from Natalia's "Baltimore Ravens Service DRAFT 07.01.26.doc".
HARD RULE (Natalia, Ahmad confirmed): build EXACTLY as-is, wording-for-wording.
Do NOT AI/rewrite/paraphrase ANY section. The variable bits (parties, venue,
dates, fee table) become template fields; every fixed clause is reproduced word-for-word.
Smart quotes/apostrophes shown as standard quotes (paste artifacts normalized; wording unchanged).
-->

# ANC Service Contract Agreement — Source (Ravens / M&T Bank Stadium draft)

AGREEMENT ("Agreement") dated June 30, 2026 between ANC SPORTS ENTERPRISES, LLC, a Delaware limited liability company located at 2 Manhattanville Road, Purchase, NY 10577 ("ANC") and Baltimore Ravens Limited Partnership with office at 1101 Russell Street, Baltimore, MD 21230.

WHEREAS, ANC has expertise in the maintenance of video-based light-emitting diode ("LED") modules (the "LED Modules").

WHEREAS, Purchaser plays in the sports and entertainment facility currently known as M&T Bank Stadium (the "Stadium"), in which LED Modules and the necessary hardware, software, equipment and connections required to operate the Stadium LED Modules (collectively, the "LED System") have been installed for use at NFL Games and other events; and which Purchaser wishes to have ANC maintain such LED System;

NOW, THEREFORE, the parties hereto hereby agree as follows:

## ANC's Responsibilities
WHEREAS, ANC has expertise in the maintenance of video-based light-emitting diode ("LED") modules (the "LED Modules"); and

WHEREAS, Purchaser operates the sports and entertainment facility currently known as M&T Bank Stadium (the "Stadium"), in which LED Modules and the necessary hardware, parts, equipment and connections required to service and maintain the Stadium's LED Modules (collectively, the "LED System") are provided by the Purchaser for their use in NFL games, and additional events at the Stadium, and Purchaser wishes to have ANC service and maintain such LED System.
...
| Contract Year | Monthly Service Fee |
|---|---|
| 2026–2027 | $45,000.00 |
| 2027–2028 | $51,439.33 |
| 2028–2029 | $59,015.17 |
...
The fees described herein do not include any Maryland sales or use tax that may be due. ANC shall determine whether any such tax is payable on the fees, and, if such tax is due, ANC will bill Company for such tax and will be responsible for remitting the tax, as paid by Company, to the appropriate taxing authorities.

Time is of the essence with regard to all payments. If Company is thirty (30) days late in any non-disputed payment due hereunder, ANC shall 1) provide written notice of such delinquency to Company in accordance with paragraph 7(a) of the General Terms. Provided that ANC has fully complied with its obligations hereunder as of the date of written notice, ANC will have the right to terminate this Agreement immediately upon written notice to Company if Company has not cured such payment default within thirty (30) days after Company's receipt of such delinquency notice.

Please sign to indicate Purchaser's agreement to purchase the Work as described herein and to authorize ANC to commence production of the Work. If, for any reason, Purchaser terminates this Agreement prior to the completion of the Work, ANC will immediately cease all work and Purchaser will pay ANC for any work performed, work in progress, and materials purchased, if any. Tax is not included. Applicable sales tax will be included in ANC's invoice. Payment is due within thirty (30) days of ANC's invoice(s).

UNLESS OTHERWISE NOTED IN THE FOLLOWING SPACE, ALL TERMS AND CONDITIONS ON THE GENERAL TERMS OF THIS ORDER ARE FULLY ACCEPTED BY PURCHASER.
...
Baltimore Ravens Limited Partnership ("Purchaser")
1101 Russell Street
Baltimore, MD 21230
...
These general terms apply to the work performed by ANC Sports Enterprises, LLC ("ANC") as described in the attached sales proposal (the "Work") and the acceptance of such Work by Purchaser:
...
---
_Footer/cover text present in source:_ "Baltimore Ravens M&T Bank Stadium Service Contract / Sales Proposal"
