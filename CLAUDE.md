...
- Build from Scratch launch repair (Natalia 2026-07-10): Setup no longer presents the reduced screen grid as if it were the builder. It explains the Setup → Configure handoff and opens the full workspace (products/pitch/dimensions/costs/margins/manual items/SOW/free-form tables) from a prominent action. Intelligence projects now render the live proposal without an Excel upload; Mirror/AI import remains workbook-gated. Preview-state regression tests cover both modes.
