...
# Create persistent data directory for RFP PDFs (EasyPanel volume mounted at /rfp-data)
RUN mkdir -p /rfp-data/rfp-uploads && chown nextjs:nodejs /rfp-data /rfp-data/rfp-uploads
